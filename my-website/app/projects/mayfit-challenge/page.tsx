export default function MayfitChallengePage() {
  return (
    <main className="min-h-screen flex justify-center pt-24 pb-16">
      <div className="max-w-3xl px-8 w-full">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
          An iPhone app that uploads, retrieves, and visualizes friends' weekly step and calorie data in SwiftUI powered by CloudKit.
        </p>
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
            <li>Data upload and retrieval</li>
            <li>Friends' data visualization</li>
